...
- Fix incorrect javascript destructuring colors in certain conditions. [#203](https://github.com/mathcale/dracula-theme-refined/issues/203)
- Correctly highlight PHP semicolons when php expression is inside string. [#208](https://github.com/mathcale/dracula-theme-refined/issues/208)
- Fix issue preventing folded regions from receiving any highlight colors. [#210](https://github.com/mathcale/dracula-theme-refined/issues/210)
...
- Add secondary button styles. (closes [#176](https://github.com/mathcale/dracula-theme-refined/issues/176))

### Fix

- Remove preset contrast borders. (closes [#120](https://github.com/mathcale/dracula-theme-refined/issues/120), [#147](https://github.com/mathcale/dracula-theme-refined/issues/147))
- Improve contrast of "open a remote window" button. (closes [#146](https://github.com/mathcale/dracula-theme-refined/issues/146))

## 2.22.4

### Fix

- Address broken style property in html filetypes. [#177](https://github.com/mathcale/dracula-theme-refined/issues/177)
